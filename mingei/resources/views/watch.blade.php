        ...
        <div class="mx-auto max-w-7xl py-6 px-6 lg:px-8">
            ...
            <div class="flex mt-6">
                <div x-data="{ follow : false, keep : false }" class="flex flex-wrap">
                    ...
                    <button class="flex items-center space-x-1 p-2 bg-white whitespace-nowrap mr-2 outline-none ring-2 ring-gray-300 font-medium rounded-full text-xs text-center">
