        ...
        <form>
            <div class="space-y-12">
                <div class="border-b border-gray-900/10 pb-12">
                    <h2 class="text-base font-semibold leading-7 text-gray-900">公開情報</h2>
                    <p class="mt-1 text-sm leading-6 text-gray-600">この情報は公開されます。共有する内容には注意してください。また、お客さんから検索の対象になりますので、正しい情報を入力してください。</p>
