<x-app-layout>
  ...
  ```
-->
        <div x-data="{ isDragging: false, file: null }" x-on:dragover="isDragging = true" x-on:dragleave="isDragging = false" x-on:drop="isDragging = false; file = event.dataTransfer.files[0]">
            <form>
