...
<div>
    ...
    <button wire:click="toggleFollow" class="bg-orange-400 text-white flex items-center space-x-1 p-2 whitespace-nowrap mr-2 outline-none ring-2 ring-gray-300 font-medium rounded-full text-xs text-center">
    ...
    @else
    <button wire:click="toggleFollow" class="flex items-center space-x-1 p-2 whitespace-nowrap mr-2 outline-none ring-2 ring-gray-300 font-medium rounded-full text-xs text-center">
