<div class="flex flex-col mb-12 overflow-hidden">
    <a href="{{ route('watch', ['videoId' => $id]) }}" class="flex-shrink-0">
        <img src="{{ $src }}" alt="{{ $alt }}">
    </a>
    <div class="flex flex-col justify-between flex-1">
        <div class="flex-1">
            <a href="{{ route('watch', ['videoId' => $id]) }}" class="flex pt-3 space-x-1 text-sm text-gray-500">
            ...
            <p class="text-lg font-normal text-gray-500"><a href="{{ route('watch', ['videoId' => $id]) }}">{{ $description }}</a></p>
